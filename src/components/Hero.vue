...
const socialIcons = [
    {
        name: 'Facebook',
        svg: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-6 h-6" viewBox="0 0 16 16">
    ...
    //{ name: 'Twitter', src : '../images/twitter.svg', color: 'blue'},
    //{ name: 'Whatsapp', src : '../images/whatsapp.svg', color: 'green'},
...
.radial-gradient-red {
    background: magenta;
    background: radial-gradient(circle, orangered 0%, rgba(149, 0, 0, 0) 68%);
}

.radial-gradient-cyan {
    background: cyan;
    background: radial-gradient(circle, cyans 0%, rgba(149, 0, 0, 0) 68%);
}
...
.circle-animation::before {
    ...
    position: absolute;
    inset: 0;
    background: radial-gradient(#d00, #a00);
    border-radius: 50%;
    z-index: -1;
    opacity: 0;
